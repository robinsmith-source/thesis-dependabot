...
-- CreateEnum
CREATE TYPE "RecipeStepType" AS ENUM ('PREP', 'COOK', 'REST');
...
-- CreateTable
CREATE TABLE "RecipeLabelCategory" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,

    CONSTRAINT "RecipeLabelCategory_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "RecipeLabel" (
    ...
    CONSTRAINT "RecipeLabel_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "RecipeStep" (
    ...
    "stepType" "RecipeStepType" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "_RecipeSaved_AB_unique" ON "_RecipeSaved"("A", "B");

-- CreateIndex
CREATE INDEX "_RecipeSaved_B_index" ON "_RecipeSaved"("B");
...
-- AddForeignKey
ALTER TABLE "RecipeLabel" ADD CONSTRAINT "RecipeLabel_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "RecipeLabelCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RecipeLabel" ADD CONSTRAINT "RecipeLabel_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_RecipeSaved" ADD CONSTRAINT "_RecipeSaved_A_fkey" FOREIGN KEY ("A") REFERENCES "Recipe"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_RecipeSaved" ADD CONSTRAINT "_RecipeSaved_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
